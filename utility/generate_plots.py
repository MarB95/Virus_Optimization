...
def plot_influence_of_T(df_T_mean):
    ...
    axs[0].set_title('Number of infected for different T', fontsize=20)
    axs[1].set_title('Number of deaths for different T', fontsize=20)
    fig.tight_layout()
...
def plot_influence_of_h(df_h_mean):
    ...
    axs[0].set_title('Number of infected for different h', fontsize=20)
    axs[1].set_title('Number of deaths for different h', fontsize=20)
    fig.tight_layout()
    #axs[0].xaxis.set_major_locator(MaxNLocator(integer=True))
    #axs[1].xaxis.set_major_locator(MaxNLocator(integer=True))
    for ax in axs.flat:
